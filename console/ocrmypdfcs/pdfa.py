...
ICC_PROFILE_RELPATH = '/home/ml/EPSProjects/OCRDjango/OCRDjangoApi/console/ocrmypdfcs/data/sRGB.icc'

SRGB_ICC_PROFILE = ICC_PROFILE_RELPATH
#SRGB_ICC_PROFILE = pkg_resources.resource_filename('ocrapi', ICC_PROFILE_RELPATH)
